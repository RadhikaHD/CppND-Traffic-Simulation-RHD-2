...
void Intersection::addVehicleToQueue(std::shared_ptr<Vehicle> vehicle)
{
    ...
    std::promise<void> addToWait_promise;
    std::future<void> addToWait_future = addToWait_promise.get_future();
    _waitingVehicles.pushBack(vehicle, std::move(addToWait_promise));
    addToWait_future.wait();
